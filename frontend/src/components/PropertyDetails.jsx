        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {similarProperties.map((similarProperty, index) => (
              <motion.div
                key={similarProperty.property_id}
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                ...
                whileHover={{ y: -8 }}
                onClick={() =>
                  navigate(`/property/${similarProperty.property_id}`, {
                ...
                <div className="relative overflow-hidden h-64">
                  ...
                  <div className="absolute top-4 left-4">
                    <span
                      className={`text-xs font-semibold px-3 py-1 rounded-full shadow-sm ${
                        similarProperty.listing_type_name?.toLowerCase().includes("rent")
                          ? "bg-blue-100 text-blue-700"
                          : "bg-green-100 text-green-700"
                      }`}
                    >
                      For {similarProperty.listing_type_name?.toLowerCase().includes("rent") ? "Rent" : "Sale"}
                    </span>
                  </div>
                  ...
                  <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <button 
                      ...
                      className="p-2 bg-white/90 rounded-full backdrop-blur-sm text-gray-700 hover:bg-red-100 hover:text-red-600 transition-colors"
                    >
                      <Heart size={16} />
                    </button>
                    <button 
                      ...
                      className="p-2 bg-white/90 rounded-full backdrop-blur-sm text-gray-700 hover:bg-blue-100 hover:text-blue-600 transition-colors"
                    >
                      <Share2 size={16} />
                    </button>
                  </div>
                  ...
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
                      ...
                      <p className="flex items-center text-gray-600 text-sm">
                        ...
                        {similarProperty.location_name}, {similarProperty.location_city}
                      </p>
                    </div>
                  ...
                  <div className="flex justify-between items-center py-3 border-t border-gray-100">
                    <div className="flex items-center gap-4 text-sm text-gray-700">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>{similarProperty.area_sqft}</span>
                      </div>
                    </div>
                    {similarProperty.year_built && (
                      <div className="flex items-center gap-1 text-sm text-gray-600">
                        <Calendar size={14} />
                        <span>{similarProperty.year_built}</span>
                      </div>
                    )}
                  </div>
                  <motion.button
